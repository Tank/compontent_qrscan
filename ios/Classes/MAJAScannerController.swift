...
//                }
    ...
    func settingArgumentValue() {
        if let tintColorHex: String = qrscanArguKey.titleColor.getKeyValue(dictionary: argumentDictionary)  {
            tintColor = UIColor(hexString: tintColorHex) ?? UIColor.white
        }
        
        if let barColorHex: String = qrscanArguKey.barColor.getKeyValue(dictionary: argumentDictionary)  {
        ...
        if let scale: String = qrscanArguKey.scanAreaScale.getKeyValue(dictionary: argumentDictionary)  {
